        ...
        <div className="flex space-bw">
          <div className="col-25 profile-top">
            <div className="profile-icon text-center">
              <FaUser className="main-icon" size={100} />
            </div>
            ...
            <Link to="/login-security" className="user-logout text-center">
              <button>Edit Profile</button>
            </Link>

            <div className="user-logout text-center" onClick={logoutUserbtn}>
          ...
          <div className="col-75">
            <div className="flex align-center space-bw">
              <div className="col-33 flex align-center space-bw your-order-top">
                <div className="order-img col-40">
